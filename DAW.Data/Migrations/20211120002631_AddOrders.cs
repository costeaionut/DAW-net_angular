    ...
    public partial class AddOrders : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderPaintings", x => new { x.OrderId, x.PaintingId });
                    table.ForeignKey(
                        name: "FK_OrderPaintings_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderPaintings_Paintings_PaintingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderPaintings_PaintingId",
                table: "OrderPaintings",
                column: "PaintingId");
